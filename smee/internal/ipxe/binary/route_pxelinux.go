...
// dashed-upper MAC address. The MAC is extracted from the path, used
// to look up Hardware, and the Hardware's PXELINUX.Template is served.
//
...
// the matched Hardware has no PXELINUX.Template. In all of those cases
