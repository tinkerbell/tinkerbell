...
func (b *Backend) ReadAll(ctx context.Context, workerID string) ([]tinkerbell.Workflow, error) {
...
func (b *Backend) Write(ctx context.Context, wf *tinkerbell.Workflow) error {
