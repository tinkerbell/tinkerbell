	...
	tests := map[string]struct {
		...
		"complete input": {
			input: &proto.AgentAttributes{
				...
				Memory: &proto.Memory{
					TotalBytes:  toPtr(int64(32_000_000_000)),
					UsableBytes: toPtr(int64(31_000_000_000)),
				},
				Block: []*proto.Block{
					{
						Name:                   toPtr("nvme0n1"),
						...
						DriveType:              toPtr("SSD"),
						SizeBytes:              toPtr(int64(239_000_000_000)),
						PhysicalBlockSizeBytes: toPtr(int64(512)),
