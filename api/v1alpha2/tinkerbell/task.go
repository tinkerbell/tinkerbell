...
// +kubebuilder:resource:path=tasks,scope=Namespaced,categories=tinkerbell,shortName=t,singular=task
// +kubebuilder:storageversion

// Task is the Schema for the Task API.
// A Task is a reusable definition of Actions that can be referenced by Workflows for execution on Hardware.
type Task struct {
...
// Action represents a Task Action.
type Action struct {
