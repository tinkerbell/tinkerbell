...
// +kubebuilder:resource:path=rulesets,scope=Namespaced,categories=tinkerbell,shortName=rsw,singular=ruleset
// +kubebuilder:storageversion

// RuleSet is the Schema for the RuleSet API.
type RuleSet struct {
...
// RuleSetWorkflow defines the Workflow to be created when a rule matches.
